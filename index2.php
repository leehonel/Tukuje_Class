<?php
	...
	{
				header("Location:attendance_report2.php");
		header("Location:.php");
		exit();
	}
	if(isset($_POST['submit']))
    {
		if(isset($_POST['username']) && !empty($_POST['username']) && isset($_POST['password']) && !empty($_POST['password']))
		{
			...
			# stmt for matching entered uname and pswd with db 
			$stmt = $conn->prepare("SELECT * FROM faculty_users WHERE email = :e AND national_no = :p"); 
	...
	<section class="login-content">
		...
		<div class="login-box">
			<form class="login-form" action="" method="POST">
				<h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>LECTURER</h3>
